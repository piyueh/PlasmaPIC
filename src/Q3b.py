...
dt_e = 1e-7 # time step, [s]
dt_i = 1e-7 # time step, [s]
...
V0_i[:int(Ni/2)] = numpy.random.random_integers(1e2, 1e3, (int(Ni/2), 3))
V0_i[int(Ni/2):] = numpy.random.random_integers(-1e3, -1e2, (Ni-int(Ni/2), 3))
...
pyplot.savefig("../figures/Q3b.png", dpi=75)
pyplot.show()
