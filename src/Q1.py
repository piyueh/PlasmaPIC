##
# @file main.py
# @brief solution to the question 1 in homework 5
...
ax.plot(trace[0, :], trace[1, :], trace[2, :], 
        lw=2, color='k')
ax.set_title('Trace of the Electron\nin the Question 1', 
        fontsize=18)
ax.set_xlim(-2.5e-5, 0)
ax.set_xticks([-25e-6, -20e-6, -15e-6, -10e-6,-5e-6, 0])
ax.set_xticklabels([-25, -20, -15, -10e-6,-5, 0])
...
pyplot.savefig("../figures/Q1.png", dpi=75)
pyplot.show()
